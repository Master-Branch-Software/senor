...
- Reviewer checklist: does the change match the ticket, is the test coverage appropriate, does the copy match the voice guide (`brand-and-copywriting.md`), does the styling honor the design tokens (`css-and-layout.md` and the token tiers).

### Git hooks

`code-style-and-quality.md` covers setup details. Every repository installs hooks for:
...
- Keep the number of root-level tools minimal; `code-style-and-quality.md` covers the exact setup.
