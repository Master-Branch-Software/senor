...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| New website from scratch                                               | `14-discovery-and-communication.md` then `01`, `02`, `03`, `04`, `05`, `06`, `07`, `08`, `10`, `11`, `12`, `13`, `15`           | —                                                                                                                  |
...
| Launch/pre-deploy checklist                                            | `13-security.md`, `06-performance.md`, `05-accessibility.md`, `09-anti-patterns-and-process.md`, `15-code-style-and-quality.md` | —                                                                                                                  |
| Bug fix or review comment                                              | Subject-matter chapter + `09-anti-patterns-and-process.md`                                                                      | —                                                                                                                  |
| Discovery, scoping, staged asks, red-flag phrases                      | `14-discovery-and-communication.md`                                                                                             | —                                                                                                                  |

## Domain checklists

Run these before submitting any artifact — not as a read, but as a scan of work already produced.

- **Copy:** 14-item AI copy DNA quick checklist — `references/02-brand-and-copywriting.md` § Quick checklist for any draft. Address every hit.
- **Design:** AI design fingerprints audit — `references/09-anti-patterns-and-process.md` § AI design fingerprints. Remove or justify every match.
