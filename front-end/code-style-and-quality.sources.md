# Sources — code-style-and-quality.md

Citations backing claims in [`code-style-and-quality.md`](code-style-and-quality.md). Developer artifact — not loaded by skill consumers. Update in the same commit when chapter rules change.
...
## HTML formatting conventions referenced in `javascript-and-html.md`

The "HTML code style" section in `javascript-and-html.md` — vertical-rhythm rule and void-element trailing-slash rule — is sourced in `javascript-and-html.sources.md`. This sidecar covers the toolchain (Prettier, ESLint, Stylelint, commitlint, hooks) only.
