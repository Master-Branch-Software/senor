...
Disagreement is the design move. For each fingerprint above that the brief does not explicitly require, choose the opposite or omit. Defaults are choices; an undeliberated default is the fingerprint itself. See `visual-design.md` § "Designing against AI defaults".
...
- Follows the brand voice documented in `brand-and-copywriting.md`.
- Buttons use verbs.
