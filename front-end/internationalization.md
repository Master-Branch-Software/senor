...
Logical properties are the reason `css-and-layout.md` recommends them universally, not just for i18n. Once you use `margin-inline-start` everywhere, adding RTL support is nearly free.
