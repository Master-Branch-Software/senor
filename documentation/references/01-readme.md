...
A reader scanning a README needs to answer four questions in under a minute: *what is this, does it solve my problem, can I use it, where do I learn more.* If any of those is unanswered above the fold, the README has failed.
