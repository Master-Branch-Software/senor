# Sources — 07-javascript-and-html.md

Citations backing claims in [`07-javascript-and-html.md`](07-javascript-and-html.md). Developer artifact — not loaded by skill consumers. Update in the same commit when chapter rules change.
...
The HTML spec is silent beyond [WHATWG: a newline is suggested after DOCTYPE and around `<html>`](https://html.spec.whatwg.org/multipage/syntax.html). Codified rules in chapter 7 are derived from the empirical practice in:
