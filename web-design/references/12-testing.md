...
export const handlers = [
  http.get('/api/products', () => {
    return HttpResponse.json([
      { id: '1', name: 'Widget', price: 29, inStock: true },
    ]);
  }),
...
Budget manual accessibility review on every significant change. The manual checklist in `05-accessibility.md` covers this.
