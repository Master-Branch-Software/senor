...
See `front-end/references/12-internationalization.md` for the technical mechanics.
...
Pick one, document local extensions, lint against the result. See `front-end/references/15-code-style-and-quality.md` § Style guides for tooling.
