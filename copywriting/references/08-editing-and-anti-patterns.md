...
Drafts are written; pieces are edited into existence. For the 24-pattern AI copy DNA scan, read `front-end/references/02-brand-and-copywriting.md` § AI copy DNA. This chapter assumes that scan is part of every editing pass.
...
Run the 14-item Quick checklist from `front-end/references/02-brand-and-copywriting.md` § Quick checklist.
...
| --------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Blogs     | "In conclusion" closers, listicles that don't deliver the count, missing dates, unattributed claims | `04-blogs-and-articles.md` § Endings; § Listicles                          |
| Marketing | Compound offers, manufactured urgency, marketing-speak verbs, generic headlines                     | `05-websites-and-marketing.md` § What does not work                        |
| Web pages | "Empower"/"unleash"/"transform", two primary CTAs, stock-photo visuals                              | `front-end/references/02-brand-and-copywriting.md` § Hero section patterns |
| Technical | Conditional sprawl, encyclopedic tutorials, missing verification, stale screenshots                 | `06-technical-writing.md` § Common failures                                |
| Research  | Buried thesis, unnamed limitations, citation chains, methods that aren't reproducible               | `07-research-and-academic.md` § Common failures                            |
