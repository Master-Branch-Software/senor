...
Long-form online prose. This chapter is about the prose. For blog _page_ chrome (TOC, byline, dates, structured data), see `front-end/references/02-brand-and-copywriting.md` § Blog or article page.
...
Meta description (SEO excerpt) is separate — 150–160 characters, written for the search results page. See front-end/02 § SEO.
...
Working formulas (deeper catalog in front-end/02 § Headline formulas):
...
2. Sentence length variation. See `01-foundations.md` § Sentence rhythm.
