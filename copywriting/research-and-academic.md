...
If a claim is true, state it. If not, fix the claim. See `editing-and-anti-patterns.md` § Hedging — the difference for the editing-pass cut/keep test.
...
- Brand voice in executive summary; research voice in body. Two different registers (see `register-and-formality.md`).
